...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 29 avr. 2024 à 12:14
...
CREATE TABLE `commentaire` (
  ...
  `titre_com` varchar(50) NOT NULL,
  `avis_com` varchar(500) NOT NULL,
...
INSERT INTO `commentaire` (`id_com`, `titre_com`, `avis_com`, `note_com`, `date_com`, `id_utilisateur`, `id_film`) VALUES
(13, 'Film trop bien !', 'WOOOOOOOA', 4, '2024-04-15', 31, 40),
(14, 'Nonnn', 'c\'est null', 1, '2024-04-15', 31, 40),
(15, 'Fassssst', 'Vraiment bel les autos', 5, '2024-04-29', 32, 1);
...
(21, 'Le Driver Administrateur', 'k@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$Y29GMWdoU05VbUsxblN4bQ$R8uSFaW+IUPhfSfSVBEs9wkQcuAqwRAddTaFye8vQwQ'),
(28, 'ThomasMich', 'thomasmichelinpro@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$Q2xzMjAyTE5KeVY3UHU1Yg$lwD5R/AYNHDi9KTqUeVhWH925fKzZxWwjr63xmaJf3k'),
(29, 'Dany', 'Dany@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$WVA4V2VOd0FSQUp3QjZzaw$Os04R6ZSJhFUX+7K6k/VjoDJ5ikuGZSo2lKawKFeY5Q'),
(30, 'toto', 'toto@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$aVV2bUpyYXo5T1dmV20vTA$ABpD7ioDzikbPXwmQLKZZ08U3dVwlkeRE47FCOjXw2Y'),
(31, 'Smic', 'somichelin@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$bjV4RTM5RDVxYUgzNmZNMQ$iyihr1UBrBvl8CGTGoDCOW2/NP21Igza9P9JASkjGw4'),
(32, 'DanyIlo', 'lemoderateurdelive@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$cHRiYy9IVnZBaUxwNTVoSw$0CyFVDX8tzJv07lhez9Li1Hth5y3CMLLv98+0+EoFi4');
...
ALTER TABLE `commentaire`
  ...
  ADD KEY `FK_com_utilisateur` (`id_utilisateur`) USING BTREE,
  ADD KEY `FK_com_film` (`id_film`) USING BTREE;
...
ALTER TABLE `film`
  ...
  ADD KEY `FK_film_utilisateur` (`id_utilisateur`) USING BTREE;
...
--
ALTER TABLE `commentaire`
  MODIFY `id_com` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
